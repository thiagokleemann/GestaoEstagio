      ...
      <form @submit.prevent="loginGoogle">
        ...
        <button class="gsi-material-button">
          ...
          <div class="gsi-material-button-content-wrapper">
            ...
            <span class="gsi-material-button-contents">{{ $t('message.login.google') }}</span>
            <span style="display: none;">{{ $t('message.login.google') }}</span>
          </div>
        </button>
  ...
  methods: {
    async loginGoogle() {
      ...
      try {
        ...
        window.location.href = this.$store.getters.googleLoginUrl;
